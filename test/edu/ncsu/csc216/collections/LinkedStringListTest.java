...
public class LinkedStringListTest {
	...
	/**
	 * Tests that a LinkedStringList is constructed correctly.  A LinkedStringList of
	 * any generic type should be not null and empty, which implies a size of 0.
	 * Test method for {@link edu.ncsu.csc216.collections.LinkedStringList#LinkedStringList()}.
	 */
	@Test
	public void testLinkedStringList() {
		...
		ListNode firstNode = new ListNode("Start");
		LinkedStringList list2 = new LinkedStringList(firstNode);
		//Check that the list is not null
		assertNotNull(list2);
		...
		LinkedStringList list3 = new LinkedStringList(firstNode);
		//Check that the list is not null
		assertNotNull(list3);
	...
	/**
	 * Tests adding elements to an empty LinkedStringList.  Then tests adding elements to the 
	 * front, middle, and back of a LinkedStringList.  The size and contents should be checked
	 ...
	 * Test method for {@link edu.ncsu.csc216.collections.LinkedStringList#add(int, java.lang.Object)}.
	 */
	@Test
	 ...
	 * Test method for {@link edu.ncsu.csc216.collections.LinkedStringList#remove(int)}.
	 */
	@Test
	 ...
	 * Test method for {@link edu.ncsu.csc216.collections.LinkedStringList#set(int, java.lang.Object)}.
	 */
	@Test
	 ...
	 * Test method for {@link edu.ncsu.csc216.collections.LinkedStringList#get(int)}.
	 */
	@Test
