...
public class LinkedListTest {
	...
	/**
	 * Tests that a LinkedListIterator is constructed correctly. A ListIterator created
	 * with a defined index should start at that index. If an index is not defined, the
	 * ListIterator should start at index 0.
	 * Test method for {@link edu.ncsu.csc216.collections.LinkedList#LinkedList()}.
	 */
	@Test
	public void testLinkedListIterator() {
		//Test that a ListIterator can be created correctly
		//Check that a ListIterator for an empty list is not null at index 0
		assertNotNull(list.listIterator());
		
		//Try to create a ListIterator at an index of 2 when the list is empty
		try{
			list.listIterator(2);
		...
		//Add an element, then check that a ListIterator is not null at index 1
		list.add("blueberry");
